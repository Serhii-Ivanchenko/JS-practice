...
// const newArr = arr.map(number => Math.pow(number, 2));
// console.log(newArr);
...
// const valuesArr = data.flatMap(item => item.values);
...
// }
// console.log(numbersSorting(numbersArray));
...
// const objSort = obj => {
//   return obj.toSorted((a, b) => a.age - b.age);
// };
...
// const adultFilter = obj => {
//     return obj.filter(user => user.age > 20)
// }

// console.log(adultFilter(user));
